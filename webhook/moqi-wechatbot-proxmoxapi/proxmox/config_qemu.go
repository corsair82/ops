...
//NodePcisConfig - Proxmox API Node Hardware Pcis

type NodePicsConfig struct {
...
//data:ConfigQemu - Proxmox API QEMU options
type VmConfigQemuData struct {
	Data ConfigQemu `json:"data"`
}
...
type ConfigQemu struct {
	...
	// arrays are hard, support 8 hostpcis for now
