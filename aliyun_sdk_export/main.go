...
import (
	...
	collector "aliyun_sdk_export/collector"
	"flag"
	"net/http"
	"strings"
...
var (
	opsadmin      string = "gongxuan@huatu.com"
	version       string = "v1.0"
	help          bool
...
func main() {
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(`<html>
             ...
             <body>
             <h1><a style="text-decoration:none" href=''>` + "AliyunEip_exporter" + `</a></h1>
             <p><a href='` + "metrics" + `'>Metrics</a></p>
             <h2>Build</h2>
			 <pre>` + "MetricAdmin:" + opsadmin + `</pre>
             <pre>` + version + `</pre>
             </body>
             </html>`))
	})
